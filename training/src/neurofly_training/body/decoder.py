...
abdomen actuators read the descending neurons. Its weights are a parameter
vector you can train (see scripts/train_es.py).
"""
from __future__ import annotations

import numpy as np

from neurofly_training.body.actuators import HEAD_ABDOMEN_INDICES, leg_actuator_indices
from neurofly_training.data.connectome import LEGS
